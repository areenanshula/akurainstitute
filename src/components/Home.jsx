...
function Home({courses, buyCourse }) {
    ...
    <div className="d-flex container-fluid p-0 m-0">
      ...
      >
        <div className="text-center">
          <a
            href="/"
            className="mb-3 mt-5 mb-md-0 me-md-auto text-center text-white text-decoration-none fs-4"
          >
            AKURA INSTITUTE
          </a>
        </div>
        ...
        <ul className="nav nav-pills flex-column mb-auto">
          ...
          <li className="nav-item mb-2">
            <Link to="/noticeboard" className="nav-link text-white m-0 p-0">
              <a href="#" className="nav-link text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
        ...
        {/* <p className="mb-0 pb-0">Powered by ARENSLA-MEDIA</p> */}
        <hr />
